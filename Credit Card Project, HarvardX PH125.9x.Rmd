...
This is the final project for the HarvardX: PH125.9x Data Science: Capstone
course and for the HarvardX Data Science Professional Certificate. All the courses of the professional certificate gave us the knowledge and the tools to make this capstone project. In this opportunity, I will create a model that can analyze and predict when a transaction made with a credit card was a fraud or a legal transaction.
